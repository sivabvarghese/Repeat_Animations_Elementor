...
namespace RepeatAnimationsElementor;
...
class Plugin {
	...
	public function widget_scripts() {
		//wp_register_script( 'elementor-hello-world', OPACITY_PLUGIN_ASSETS_URL . 'js/hello-world.js', [ 'jquery' ], false, true );
	}
	...
	public function editor_scripts() {
		...
		wp_enqueue_script(
			...
			OPACITY_PLUGIN_ASSETS_URL . 'js/editor/editor.js',
			[
				'elementor-editor',
			],
			'1.2.1',
